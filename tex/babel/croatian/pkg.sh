...
# adding the Babel croatian to the kerTeX installation.
#
...
pkg_post_apply()
{
	if pkg_is_installed latex/croatian; then
		pkg_remove latex/croatian
	fi
	pkg_remove_rcp_obsolete latex/croatian
	return 0 # bash errors on empty function...
}
...
DESCRIPTION:
	Babel contrib for croatian for the LaTeX engine
KXPATH:
	tex babel/croatian
SOURCES:
	LCD HOME/..
	GET /macros/latex/contrib/babel-contrib/croatian.zip
END:
END_CID
