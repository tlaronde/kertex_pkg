...
# adding the Babel catalan to the kerTeX installation.
#
...
pkg_post_apply()
{
	if pkg_is_installed latex/catalan; then
		pkg_remove latex/catalan
	fi
	pkg_remove_rcp_obsolete latex/catalan
	return 0 # bash errors on empty function...
}
...
DESCRIPTION:
	Babel contrib for catalan for the LaTeX engine
KXPATH:
	tex babel/catalan
SOURCES:
	LCD HOME/..
	GET /macros/latex/contrib/babel-contrib/catalan.zip
END:
END_CID
