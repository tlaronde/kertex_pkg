...
# adding the Babel latin to the kerTeX installation.
#
...
pkg_post_apply()
{
	if pkg_is_installed latex/latin; then
		pkg_remove latex/latin
	fi
	pkg_remove_rcp_obsolete latex/latin
	return 0 # bash errors on empty function...
}
...
VERSION: 4.0 2021-06-27
LICENCE: The LaTeX Project Public License 1.3
KERTEX_VERSION: 0.99.22.0
DESCRIPTION:
	Babel contrib for latin for the LaTeX engine
KXPATH:
	tex babel/latin
SOURCES:
	LCD HOME/..
	GET /macros/latex/contrib/babel-contrib/latin.zip
END:
END_CID
