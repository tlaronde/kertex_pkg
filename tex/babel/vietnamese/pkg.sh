...
# adding the Babel vietnamese to the kerTeX installation.
#
...
pkg_post_apply()
{
	if pkg_is_installed latex/vietnamese; then
		pkg_remove latex/vietnamese
	fi
	pkg_remove_rcp_obsolete latex/vietnamese
	pkg_remove_rcp_obsolete latex/./vietnamese
	return 0 # bash errors on empty function...
}
...
VERSION: 1.4 2015-12-31
LICENCE: The LaTeX Project Public License 1.3
KERTEX_VERSION: 0.99.22.0
DESCRIPTION:
	Babel contrib for vietnamese for the LaTeX engine
KXPATH:
	tex babel/vietnamese
SOURCES:
	LCD HOME/..
	GET /macros/latex/contrib/babel-contrib/vietnamese.zip
END:
END_CID
