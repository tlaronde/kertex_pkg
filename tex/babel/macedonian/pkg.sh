...
# adding the Babel macedonian to the kerTeX installation.
#
...
pkg_post_apply()
{
	if pkg_is_installed latex/macedonian; then
		pkg_remove latex/macedonian
	fi
	pkg_remove_rcp_obsolete latex/macedonian
	return 0 # bash errors on empty function...
}
...
BEGIN_CID
NAME: tex/babel/macedonian
VERSION: 2016-02-05
LICENCE: The LaTeX Project Public License 1.3
KERTEX_VERSION: 0.99.22.0
DESCRIPTION:
	Babel contrib for macedonian for the LaTeX engine
KXPATH:
	tex babel/macedonian
SOURCES:
	LCD HOME/..
	GET /macros/latex/contrib/babel-contrib/macedonian.zip
END:
END_CID
