...
# adding the Babel polish to the kerTeX installation.
#
...
pkg_post_apply()
{
	if pkg_is_installed latex/polish; then
		pkg_remove latex/polish
	fi
	pkg_remove_rcp_obsolete latex/polish
	return 0 # bash errors on empty function...
}
...
DESCRIPTION:
	Babel contrib for polish for the LaTeX engine
KXPATH:
	tex babel/polish
SOURCES:
	LCD HOME/..
	GET /macros/latex/contrib/babel-contrib/polish.zip
END:
END_CID
