...
# adding the Babel azerbaijani to the kerTeX installation.
#
...
pkg_post_apply()
{
	if pkg_is_installed latex/azerbaijani; then
		pkg_remove latex/azerbaijani
	fi
	pkg_remove_rcp_obsolete latex/azerbaijani
	return 0 # bash errors on empty function...
}
...
BEGIN_CID
NAME: tex/babel/azerbaijani
VERSION: 1.0a 2017-05-03
LICENCE: The LaTeX Project Public License 1.3
KERTEX_VERSION: 0.99.22.0
DESCRIPTION:
	Babel contrib for azerbaijani for the TeX engines
KXPATH:
	tex babel/azerbaijani
SOURCES:
	LCD HOME/..
	GET /macros/latex/contrib/babel-contrib/azerbaijani.zip
END:
END_CID
