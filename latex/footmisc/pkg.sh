...
$PKG_UNZIP footmisc.zip
rm footmisc.zip
cd $TMPDIR/lib/$PKG_NAME/
$KERTEX_BINDIR/latex footmisc.ins
...
BEGIN_CID
NAME: latex/footmisc
VERSION: 6.0f 2023-07-05
LICENCE: LaTeX Project Public Licence 1.3c
KERTEX_VERSION: 0.99.22.0
DESCRIPTION: A range of footnote options.
KXPATH:
	latex footmisc
SOURCES:
	LCD HOME/..
	GET /macros/latex/contrib/footmisc.zip
END:
END_CID
