...
# adding the Babel russian to the kerTeX installation.
#
...
pkg_post_apply()
{
	if pkg_is_installed latex/russian; then
		pkg_remove latex/russian
	fi
	pkg_remove_rcp_obsolete latex/russian
	return 0 # bash errors on empty function...
}
...
VERSION: 1.3m 2021-01-10
LICENCE: The LaTeX Project Public License 1.3
KERTEX_VERSION: 0.99.22.0
DESCRIPTION:
	Babel contrib for russian for the LaTeX engine
KXPATH:
	tex babel/russian
SOURCES:
	LCD HOME/..
	GET /macros/latex/contrib/babel-contrib/russian.zip
END:
END_CID
