...
# adding the Babel bulgarian to the kerTeX installation.
#
...
pkg_post_apply()
{
	if pkg_is_installed latex/bulgarian; then
		pkg_remove latex/bulgarian
	fi
	pkg_remove_rcp_obsolete latex/bulgarian
	return 0 # bash errors on empty function...
}
...
VERSION: 1.2g 2013-10-14
LICENCE: The LaTeX Project Public License 1.3
KERTEX_VERSION: 0.99.22.0
DESCRIPTION:
	Babel contrib for bulgarian for the LaTeX engine
KXPATH:
	tex babel/bulgarian
SOURCES:
	LCD HOME/..
	GET /macros/latex/contrib/babel-contrib/bulgarian.zip
END:
END_CID
