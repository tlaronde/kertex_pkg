...
# adding the Babel swedish to the kerTeX installation.
#
...
pkg_post_apply()
{
	if pkg_is_installed latex/swedish; then
		pkg_remove latex/swedish
	fi
	pkg_remove_rcp_obsolete latex/swedish
	return 0 # bash errors on empty function...
}
...
VERSION: 2.3e 2021-02-06
LICENCE: The LaTeX Project Public License 1.3
KERTEX_VERSION: 0.99.22.0
DESCRIPTION:
	Babel contrib for swedish for the LaTeX engine
KXPATH:
	tex babel/swedish
SOURCES:
	LCD HOME/..
	GET /macros/latex/contrib/babel-contrib/swedish.zip
END:
END_CID
