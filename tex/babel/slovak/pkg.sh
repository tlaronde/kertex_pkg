...
# adding the Babel slovak to the kerTeX installation.
#
...
pkg_post_apply()
{
	if pkg_is_installed latex/slovak; then
		pkg_remove latex/slovak
	fi
	pkg_remove_rcp_obsolete latex/slovak
	return 0 # bash errors on empty function...
}
...
DESCRIPTION:
	Babel contrib for slovak for the LaTeX engine
KXPATH:
	tex babel/slovak
SOURCES:
	LCD HOME/..
	GET /macros/latex/contrib/babel-contrib/slovak.zip
END:
END_CID
